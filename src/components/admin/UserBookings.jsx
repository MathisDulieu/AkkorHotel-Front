...
const UserBookings = () => {
    ...
    const fetchUserBookings = async () => {
        ...
        try {
            const data = await getUserBookings(inputUserId);
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4">
            ...
            <h2 className="text-xl text-blue-600 italic mb-6">Find bookings by user</h2>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
                ...
                {userId && bookings.length === 0 && !loading && (
                ...
                {!userId && !error && !loading && (
                    <div className="text-center py-12 text-gray-500">
                        ...
                        <p className="text-lg">Enter a user ID and click "Search" to view bookings</p>
                    </div>
                )}
